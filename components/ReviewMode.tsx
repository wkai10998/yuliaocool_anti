...
import { generateContextScenario, generateReviewFeedback, ReviewFeedback, generateSpeech, transcribeAudio } from '../services/geminiService';
         ...
         {feedback ? (
             ...
             <>
                 ...
                 <div className="flex flex-col items-center justify-center flex-1 relative gap-4">
                    ...
                    <div className={`px-4 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all duration-300 ${
                        isRecording && !isPaused ? 'bg-red-50 text-red-500 border border-red-100' : isPaused ? 'bg-amber-50 text-amber-500 border border-amber-100' : 'bg-stone-50 text-stone-400 border border-stone-100'
                    }`}>
